...
import {
  ...
  LayoutList, LayoutTemplate, List, Layers, MessageSquareQuote, Minus, MousePointerClick, Navigation,
  Newspaper, PanelRight, Search, Sidebar as SidebarIcon, Sparkles, Star, Table, Tags, TextCursorInput,
  WrapText, Component, Database, FormInput, Settings2
} from 'lucide-react';
...
export const DEBUG_MENU_ITEMS: NavMenuNode[] = [
  {
    ...
    description: '基础',
    children: [
      { menuId: 'docs-button', menuName: 'layout.nav.development.docsButton.title', routePath: '/docs/component/button', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsButton.title' },
    ],
  },
  {
    menuId: 'Form',
    ...
    description: '表单',
    children: [
      { menuId: 'docs-input', menuName: 'layout.nav.development.docsInput.title', routePath: '/docs/component/input', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsInput.title' },
      { menuId: 'docs-text-area', menuName: 'layout.nav.development.docsTextArea.title', routePath: '/docs/component/textArea', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsTextArea.title' },
      { menuId: 'docs-select', menuName: 'layout.nav.development.docsSelect.title', routePath: '/docs/component/select', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsSelect.title' },
      { menuId: 'docs-checkbox', menuName: 'layout.nav.development.docsCheckbox.title', routePath: '/docs/component/checkbox', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsCheckbox.title' },
    ],
  },

  {
    ...
    description: '数据展示',
    children: [
      { menuId: 'docs-chip', menuName: 'layout.nav.development.docsChip.title', routePath: '/docs/component/chip', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsChip.title' },
      { menuId: 'docs-table', menuName: 'layout.nav.development.docsTable.title', routePath: '/docs/component/table', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsTable.title' },
    ],
  },
  {
    menuId: 'Navigation',
    ...
    description: '导航',
    children: [
      { menuId: 'docs-side-bar', menuName: 'layout.nav.development.docsSideBar.title', routePath: '/docs/component/sideBar', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsSideBar.title' },
      { menuId: 'docs-tab-nav', menuName: 'layout.nav.development.docsTabNav.title', routePath: '/docs/component/tabNav', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsTabNav.title' },
    ],
  },
  {
    menuId: 'Layout',
    ...
    description: '布局',
    children: [
      { menuId: 'docs-separator', menuName: 'layout.nav.development.docsSeparator.title', routePath: '/docs/component/separator', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsSeparator.title' },
      { menuId: 'docs-anim-card', menuName: 'layout.nav.development.docsAnimCard.title', routePath: '/docs/component/animCard', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsAnimCard.title' },
      { menuId: 'docs-news-card', menuName: 'layout.nav.development.docsNewsCard.title', routePath: '/docs/component/newsCard', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsNewsCard.title' },
      { menuId: 'docs-list-card', menuName: 'layout.nav.development.docsListCard.title', routePath: '/docs/component/listCard', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsListCard.title' },
    ],
  },

  {
    ...
    description: '浮层',
    children: [
      { menuId: 'docs-drawer', menuName: 'layout.nav.development.docsDrawer.title', routePath: '/docs/component/drawer', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsDrawer.title' },
      { menuId: 'docs-toast', menuName: 'layout.nav.development.docsToast.title', routePath: '/docs/component/toast', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsToast.title' },
      { menuId: 'docs-modal', menuName: 'layout.nav.development.docsModal.title', routePath: '/docs/component/modal', menuPosition: 'content', level: 1, menuExpanded: false, description: 'layout.nav.development.docsModal.title' },
    ],
  },
];
