...
const zh = {
  ...
  'layout.nav.alerts': '告警', // 告警導航項
  'layout.nav.backtest': '回測', // 回測導航項
  'layout.nav.chat': '問股', // 問股導航項
  ...
  'layout.route.alerts.description': '规則、触發記錄與通知尝試', // 告警路由描述
  'layout.route.alerts.title': '告警', // 告警路由標題
  'layout.route.backtest.description': '回測任務與結果浏覽', // 回測路由描述
  'layout.route.backtest.title': '回測', // 回測路由標題
  'layout.route.chat.description': '多轮策略問答與歷史會话管理', // 問股路由描述
  'layout.route.chat.title': '問股', // 問股路由標題
  'layout.route.decisionSignals.description': 'AI 建议、風險與观察条件', // AI 建议路由描述
  'layout.route.decisionSignals.title': 'AI 建议', // AI 建议路由標題
  'layout.route.dashboard.description': '市场行情與核心指標總覽', // 總覽路由描述
  ...
  'layout.route.watchlist.description': '自選股列表與行情追蹤', // 自選路由描述
  'layout.route.watchlist.title': '自選', // 自選路由標題
  ...
  'layout.route.settings.title': '設定', // 設定路由標題
  'layout.route.screening.description': 'AlphaSift 策略選股與候選研究', // 選股路由描述
  'layout.route.screening.title': '選股', // 選股路由標題
  'layout.route.usage.description': 'LLM Token 消耗與模型調用明細', // 用量路由描述
  ...
  'header.themeSettings': '主題設定', // 頭部主題設定按鈕
  'header.language': '界面語言', // 頭部中英文切換按鈕
  'header.userSettings': '個人設定', // 頭部個人設定按鈕
  ...
  'taskPanel.diagnostics': '运行诊断', // 运行诊断按鈕
  'taskPanel.pending': '等待中', // 任務等待中狀態
  'taskPanel.pendingTasks': '{count} 等待中', // 等待中任務數量
  'taskPanel.processing': '分析中', // 任務分析中狀態
  'taskPanel.processingAria': '任務進行中', // 任務進行中无障碍標簽
  'taskPanel.processingTasks': '{count} 進行中', // 進行中任務數量
  'taskPanel.cancelRequested': '請求取消', // 任務請求取消狀態
  'taskPanel.cancelRequestedAria': '任務請求取消', // 請求取消无障碍標簽
  'taskPanel.cancelled': '已取消', // 任務已取消狀態
  'taskPanel.pendingAria': '任務等待中', // 任務等待中无障碍標簽
  'taskPanel.openRunFlow': '查看运行流', // 查看运行流按鈕
  'taskPanel.openRunFlowAria': '查看 {stock} 运行流', // 查看运行流无障碍標簽
  'taskPanel.statusAria': '任務狀態：{status}', // 任務狀態无障碍標簽
  'taskPanel.title': '分析任務', // 任務面板標題

  'runFlow.drawerTitle': '运行流', // 运行流抽屉標題
  'runFlow.eyebrow': '运行流', // 运行流眉標
  'runFlow.title': '數據流與信息流', // 运行流主標題
  'runFlow.open': '查看运行流', // 查看运行流入口
  'runFlow.openHistoryAria': '查看歷史記錄 {recordId} 运行流', // 查看歷史运行流无障碍標簽
  'runFlow.taskDrawerTitle': '{stock} 运行流', // 任務运行流抽屉標題
  'runFlow.historyDrawerTitle': '{stock} 歷史运行流', // 歷史运行流抽屉標題
  'runFlow.loadingTitle': '正在載入运行流', // 运行流載入標題
  'runFlow.loadingDescription': '正在讀取任務快照、运行诊断和事件鏈路。', // 运行流載入說明
  'runFlow.errorTitle': '运行流載入失敗', // 运行流載入失敗標題
  'runFlow.retry': '重新載入', // 运行流重新載入
  'runFlow.refresh': '重新整理', // 运行流重新整理按鈕
  'runFlow.refreshing': '重新整理中', // 运行流重新整理中狀態
  'runFlow.emptyTitle': '暫无运行流', // 运行流空狀態標題
  'runFlow.emptyDescription': '請選擇一個活跃任務或歷史報告查看运行流。', // 运行流空狀態描述
  'runFlow.emptySnapshotTitle': '暫无运行流細節', // 运行流快照空標題
  'runFlow.emptySnapshotDescription': '目前快照沒有節點或事件；缺少 diagnostics 時會顯示骨架或空狀態。', // 运行流快照空描述
  'runFlow.valueUnavailable': '未記錄', // 运行流值不可用
  'runFlow.durationMs': '{value} ms', // 毫秒耗時顯示
  'runFlow.durationSeconds': '{value} 秒', // 秒耗時顯示
  'runFlow.durationMinutes': '{value} 分鐘', // 分鐘耗時顯示
  'runFlow.status.pending': '等待中', // 运行流等待狀態
  'runFlow.status.running': '运行中', // 运行流运行狀態
  'runFlow.status.success': '成功', // 运行流成功狀態
  'runFlow.status.failed': '失敗', // 运行流失敗狀態
  'runFlow.status.degraded': '部分降級', // 运行流降級狀態
  'runFlow.status.fallback': '降級回退', // 运行流回退狀態
  'runFlow.status.timeout': '超時', // 运行流超時狀態
  'runFlow.status.cancelRequested': '請求取消', // 运行流請求取消狀態
  'runFlow.status.cancelled': '已取消', // 运行流已取消狀態
  'runFlow.status.skipped': '已跳過', // 运行流已跳過狀態
  'runFlow.status.unknown': '未知', // 运行流未知狀態
  'runFlow.severity.info': '信息', // 信息級別
  'runFlow.severity.success': '成功', // 成功級別
  'runFlow.severity.warning': '告警', // 告警級別
  'runFlow.severity.danger': '危險', // 危險級別
  'runFlow.edge.data': '數據', // 數據邊類型
  'runFlow.edge.control': '控製', // 控製邊類型
  'runFlow.edge.fallback': '降級回退', // 回退邊類型
  'runFlow.edge.retry': '重試', // 重試邊類型
  'runFlow.edgeLabel.invoke': '調用', // 調用邊標簽
  'runFlow.edgeLabel.details': '詳情', // 詳情邊標簽
  'runFlow.nodeKind.entry': '入口', // 入口節點類型
  'runFlow.nodeKind.queue': '队列', // 队列節點類型
  'runFlow.nodeKind.dataSource': '數據源', // 數據源節點類型
  'runFlow.nodeKind.analysis': '分析', // 分析節點類型
  'runFlow.nodeKind.model': '模型', // 模型節點類型
  'runFlow.nodeKind.artifact': '产物', // 产物節點類型
  'runFlow.nodeKind.notification': '通知', // 通知節點類型
  'runFlow.summary.elapsed': '總耗時', // 运行流總耗時
  'runFlow.summary.fallbackCount': '降級回退/重試', // 回退重試次數
  'runFlow.summary.failedAttempts': '失敗尝試', // 失敗尝試次數
  'runFlow.summary.dataSources': '數據源', // 數據源數量
  'runFlow.summary.task': 'Task', // 任務標识
  'runFlow.summary.trace': 'Trace', // 追踪標识
  'runFlow.summary.model': '模型', // 模型標识
  'runFlow.summary.generatedAt': '生成時間', // 运行流生成時間
  'runFlow.graph.title': '运行拓扑', // 运行拓扑圖標題
  'runFlow.graph.description': '自動分层展示入口、數據来源、分析引擎和产物鏈路。', // 运行拓扑圖說明
  'runFlow.graph.nodeAria': '{label} 節點，狀態 {status}', // 拓扑節點无障碍標簽
  'runFlow.graph.startedAt': '開始', // 拓扑開始時間標簽
  'runFlow.graph.expand': '展開', // 展開節點按鈕
  'runFlow.graph.collapse': '收合', // 收合節點按鈕
  'runFlow.graph.expandNode': '展開 {label} 运行尝試', // 展開節點尝試
  'runFlow.graph.collapseNode': '收合 {label} 运行尝試', // 收合節點尝試
  'runFlow.events.title': '事件流', // 事件流標題
  'runFlow.events.count': '{count} 条事件', // 事件數量
  'runFlow.events.filters': '事件篩選', // 事件篩選標簽
  'runFlow.events.filter.all': '全部', // 全部事件篩選
  'runFlow.events.filter.important': '關键', // 關键事件篩選
  'runFlow.events.filter.problems': '失敗/告警', // 失敗告警事件篩選
  'runFlow.events.filter.fallback': '降級回退/重試', // 回退重試事件篩選
  'runFlow.events.filter.cancelled': '取消', // 取消事件篩選
  'runFlow.events.openNode': '查看事件 {title} 關联節點', // 查看事件關联節點
  'runFlow.events.empty': '目前篩選下暫无事件。', // 事件空狀態
  'runFlow.nodeDetails.empty': '選擇一個節點查看詳情。', // 節點詳情空狀態
  'runFlow.nodeDetails.title': '節點詳情', // 節點詳情標題
  'runFlow.nodeDetails.close': '關閉節點詳情', // 關閉節點詳情按鈕
  'runFlow.nodeDetails.kind': '類型', // 節點類型標簽
  'runFlow.nodeDetails.version': '版本', // 節點版本標簽
  'runFlow.nodeDetails.provider': '提供方', // 節點提供方標簽
  'runFlow.nodeDetails.duration': '耗時', // 節點耗時標簽
  'runFlow.nodeDetails.attempts': '尝試次數', // 節點尝試次數
  'runFlow.nodeDetails.recordCount': '記錄數', // 節點記錄數
  'runFlow.nodeDetails.startedAt': '開始時間', // 節點開始時間
  'runFlow.nodeDetails.endedAt': '結束時間', // 節點結束時間
  'runFlow.nodeDetails.metadata': '元數據', // 節點元數據
  'runFlow.nodeDetails.expandAttempts': '展開尝試', // 展開尝試按鈕
  'runFlow.nodeDetails.collapseAttempts': '收合尝試', // 收合尝試按鈕
  'runFlow.nodeDetails.attemptList': '运行尝試', // 运行尝試列表
  'runFlow.nodeDetails.contextBlocks': '上下文輸入', // 上下文輸入塊
  'runFlow.nodeDetails.column.name': '名稱', // 尝試列表名稱列
  'runFlow.nodeDetails.column.status': '狀態', // 尝試列表狀態列
  'runFlow.nodeDetails.column.duration': '耗時', // 尝試列表耗時列
  'runFlow.nodeDetails.column.records': '記錄', // 尝試列表記錄列
  'runFlow.nodeDetails.column.time': '時間', // 尝試列表時間列
  'runFlow.nodeDetails.contextQuality': '上下文质量', // 上下文质量標簽
  'runFlow.nodeDetails.overallScore': '综合评分', // 综合评分
  'runFlow.nodeDetails.qualityLevel': '等級', // 质量等級
  'runFlow.nodeDetails.blockScores': '數據塊评分', // 數據塊评分
  'runFlow.nodeDetails.count.available': '可用', // 可用數量
  'runFlow.nodeDetails.count.missing': '缺失', // 缺失數量
  'runFlow.nodeDetails.count.partial': '部分', // 部分數量
  'runFlow.nodeDetails.count.degraded': '部分降級', // 降級數量
  'runFlow.nodeDetails.count.fallback': '降級回退', // 回退數量
  'runFlow.nodeDetails.count.skipped': '跳過', // 跳過數量
