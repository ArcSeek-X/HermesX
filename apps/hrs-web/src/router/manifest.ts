...
export const MENU_MANIFEST: ModuleNode[] = [
  {
    ...
    children: [
      ...
      {
        menuId: 'stock',
        menuName: 'layout.nav.stock.title',
        routePath: 'stock',
        menuIcon: 'BarChart3',
        menuBadge: '',
        menuPosition: 'content',
        level: 0,
        menuExpanded: false,
        menuDescription: 'layout.nav.stock.description',
        menuType: 'group',
        menuVisible: true,
        children: [
          {
      ...
      {
        menuId: 'market',
        menuName: 'layout.nav.market.title',
        routePath: 'market',
        ...
        level: 0,
        menuExpanded: false,
        menuDescription: 'layout.nav.market.description',
        menuType: 'group',
        menuVisible: true,
        children: [
          {
            menuId: 'index',
            menuName: 'layout.nav.index.title',
            routePath: '/market/index',
            menuPosition: 'content',
            level: 0,
            menuExpanded: false,
            menuDescription: 'layout.nav.index.description',
            menuType: 'page',
            auth: 'protected',
            menuVisible: true,
          ...
          },
          {
            ...
            routePath: '/market/sector-analysis',
            menuPosition: 'content',
            level: 0,
            menuExpanded: false,
      ...
      {
        menuId: 'news',
        menuName: 'layout.nav.news.title',
        routePath: 'news',
        menuIcon: 'Newspaper',
        menuBadge: '',
        menuPosition: 'content',
        level: 0,
        menuExpanded: false,
        menuDescription: 'layout.nav.news.description',
        menuType: 'group',
        menuVisible: true,
        children: [
          {
      ...
      {
        menuId: 'choose',
        menuName: 'layout.nav.choose.title',
        routePath: 'choose',
        menuIcon: 'Search',
        menuBadge: '',
        menuPosition: 'content',
        level: 0,
        menuExpanded: false,
        menuDescription: 'layout.nav.choose.description',
        menuType: 'group',
        menuVisible: true,
        children: [
          {
          ...
          },
          {
            ...
            routePath: '/choose/decision-signals',
            menuPosition: 'content',
            level: 0,
            menuExpanded: false,
      ...
      {
        menuId: 'trading',
        menuName: 'layout.nav.trading.title',
        routePath: 'trading',
        ...
        level: 0,
        menuExpanded: false,
        menuDescription: 'layout.nav.trading.description',
        menuType: 'group',
        menuVisible: true,
        children: [
          {
