...
if (!smokePassword) {
  test.skip(true, 'Set HRS_WEB_SMOKE_PASSWORD to run report markdown smoke tests.');
}

test.use({ locale: 'zh-CN' });

const UI_LANGUAGE_STORAGE_KEY = 'hrs.uiLanguage';

async function login(page: Page) {
  test.skip(!smokePassword, 'Set HRS_WEB_SMOKE_PASSWORD to run report markdown tests.');
