...
if (-not $DistDir) {
  $DistDir = Join-Path $PSScriptRoot '..\apps\hrs-desktop\dist'
}
...
$packageJsonPath = Join-Path $PSScriptRoot '..\apps\hrs-desktop\package.json'
...
$expectedInstallerFileName = "hermesX-windows-installer-v$normalizedReleaseTag.exe"
