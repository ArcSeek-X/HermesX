...
**Repository**: https://github.com/ArcSeek-X/HermesX/issues
...
```bash
gh issue view <issue_number> --repo ArcSeek-X/HermesX
gh issue view <issue_number> --repo ArcSeek-X/HermesX --comments
```
